...
public class JceTokenizer extends BaseTokenizer{

	
	//关键字
	String keyWords[]={
		"module","enum","struct","require","optional","int","string","byte",
		"vector"
	};  
	
	public JceTokenizer(String fileName){
		super(fileName);
	}
	
	public JceTokenizer(ByteArrayOutputStream outStream){
		super(outStream);
	}
	...
	{  
        ...
        {  
        	...
        	return 31;
        		...
        		scanWordString.equals("long")||scanWordString.equals("vector")||
        		scanWordString.equals("string")){
        	return 32;
        }else if(scanWordString.equals("require")||scanWordString.equals("optional")){
        	return 33;
        }
...
//	            System.out.println("第 "+ lineNumber +"行，单词数"+ numberOfWords);  
	...
	protected void outputTokenModel(int index) {
	    ...
	    case 8:  
	    	//整型常量，暂不区分 
	        model.setTokenType(TokenModel.TokenType.constantint);    
	        break;  
	    case 9:  
	    	//浮点型常量，暂不区分 
	        model.setTokenType(TokenModel.TokenType.constant);  
	    ...
	    case 32:
	        ...
	        break;
	    case 33:
	    	model.setTokenType(TokenModel.TokenType.jce_is_require);
	    	break;
	    }  
